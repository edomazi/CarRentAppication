...
public class Reduceri extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reducere la studenti este de 35%");

        jLabel2.setText("Reduceri in weekenduri 20%");

        jLabel3.setText("Reducere la familii este de 50%");

        jLabel4.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 12)); // NOI18N
        jLabel4.setText("Reduceriile se aplica la pretul total!");
